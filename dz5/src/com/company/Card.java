...
public class Card implements Serializable {
    ...
    public int GetBalance(){//мтеод для получения баланса
        return Balance; }
    public void Increase(int money){//метод для увеличения баланса
        Balance += money;
    }
    public void Reduce(int money){//метод для уменьшения баланса
        Balance -= money;
    }
